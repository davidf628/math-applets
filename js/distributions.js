...
export function iiBeta(p, alpha, beta) {
...
export function risingFactorial(a, n) {
    var r = 1;
    for(var i = 0; i < n; i++) {
        r = r * (a + i);
    }
